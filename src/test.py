...
#play chord from root takes a root pitch (the I), and plays notes concurrently, offest from that pitch (1 half step up, -1 half step down)
m.play_chord_from_root(con=con, root_note=pitches.D4, chord=chords.MAJOR + [-12,-17], note_type=notetypes.QUARTER)
#play chord takes a series of arbitrary notes and plays them concurrently
